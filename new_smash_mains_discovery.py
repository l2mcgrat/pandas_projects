        ...
        for key, fights in tourney.items():
            for n, fight in enumerate(fights):
                if fight[1][0] > 0 and n <= 2:
                    character_dict[key] += (1 + n/10)*(fight[1][0] + (max(0, 200 - fight[1][1]))/200)
                elif fight[1][0] > 0 and n > 2:
                    character_dict[key] += (1 + n/10)*(fight[1][0] + (max(0, 200 - fight[1][1]))/200)/n
                elif fight[1][0] < 0 and n <= 2:
                    character_dict[key] += (1 + n/10)*(1 + fight[1][0] + min(1, fight[1][1]/200))
                elif fight[1][0] < 0 and n > 2:
                    character_dict[key] += (1 + n/10)*(1 + fight[1][0] + min(1, fight[1][1]/200))/n
                else:
                    continue
...
Tourney_1 = {
        "Megaman": [["Wii Fit Trainer", [-1, 108]], ["Opponent 2", [0, 0]], ["Opponent 3", [0, 0]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]], 
        "Diddy Kong": [["Kazuya", [-1, 19]], ["Opponent 2", [0, 0]], ["Opponent 3", [0, 0]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]], 
        "Terry": [["Ryu", [2, 129]], ["Mr Game & Watch", [2, 105]], ["Sheik", [2, 84]], ["Bowser Jr.", [2, 130]], ["Kazuya (Same)", [-1, 27]]],          
        "Palutena": [["Inkling", [-2, 60]],  ["Opponent 2", [0, 0]], ["Opponent 3", [0, 0]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]]
        }

Tourney_2 = {
        "Marth": [["Ridley", [1, 0]], ["Megaman", [-1, 14]], ["Opponent 3", [0, 0]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]], 
...
Tourney_3 = {
        ...
        "Lil Mac": [["Steve", [-1, 35]], ["Opponent 2", [0, 0]], ["Opponent 3", [0, 0]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]],          
        "Isabelle": [["Bowser", [2, 73]], ["Ken", [2, 80]], ["Mewtwo", [1, 0]], ["Bowser Jr.", [2, 39]], ["Opponent 5", [0, 0]]] 
        }

Tourney_4 = {
        "Ganondorf": [["Dark Samus", [2, 72]], ["King Dedede", [1, 84]], ["Corrin", [2, 90]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]], 
        "Lucina": [["Cloud", [1, 104]], ["Captain Falcon", [-1, 84]], ["Opponent 3", [0, 0]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]], 
        "Ike": [["Peach", [1, 62]], ["Sonic", [2, 102]], ["Ridley", [2, 111]], ["Opponent 4", [0, 0]], ["Opponent 5", [0, 0]]],          
...
Tourney_List = [Tourney_1, Tourney_2, Tourney_3, Tourney_4, Tourney_N]

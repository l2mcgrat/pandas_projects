...
round_5_scores_dict = dict(sorted(round_4_scores_dict.items(), key=lambda item: item[1], reverse=False))
...
round_5_score_distribution_evolution(Tourney_List_4, round_4_scores, copy_loss_dict)
